...
createTaxReportMassageOrder(dynamic pin, dynamic tahun, dynamic accountId) {
  ...
  // String accountId = Get.find<LoginOrderController>()
  //     .order!
  //     .value
  //     .account!
  //     .first
  ...
  createBody = Uint8List.fromList(
    createBody.toList()..addAll(set32(tahun == '' ? '0' : tahun)),
  );
    ...
    createHeader.toList()
      ..addAll(
        createPackageHeader(
          ...
          Constans.PACKAGE_ID_REQUEST_TAX_INFO_ORDER,
        ),
      ),
  );
