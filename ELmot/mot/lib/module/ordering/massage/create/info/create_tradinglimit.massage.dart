...
import 'package:online_trading/view/widget/pin/pin.widget.dart' as account;

reqTradinglimitMessageOrder({dynamic pin, dynamic stockCode}) {
  ...
  String accountId = account.accountId.value == ''
  ...
  createBody = Uint8List.fromList(
    createBody.toList()
      ..addAll(
        encodeLength(stockCode.toString().length),
      ),
  );
  createBody = Uint8List.fromList(
    createBody.toList()
      ..addAll(
        encodeString(stockCode.toString()),
      ),
  );
  createBody = Uint8List.fromList(
    createBody.toList()
    ...
    createHeader.toList()
      ..addAll(
        createPackageHeader(
          ...
          Constans.PACKAGE_ID_REQUEST_TRADING_LIMIT_ORDER,
        ),
      ),
  );
