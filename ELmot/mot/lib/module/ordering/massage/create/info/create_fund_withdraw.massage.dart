...
createFundWithDrawMoneyMassage(
  dynamic pin,
  dynamic accountId,
  String transferDate,
  int ammountTransfer,
...
//  BIASNAYA DISINI, KLO SALAH SEPUH TANGGUNG JAWAB
  createBody = Uint8List.fromList(
    createBody.toList()
      ..addAll(
        set32(transferDate),
  ...
  createBody = Uint8List.fromList(
    createBody.toList()
      ..addAll(
        set64(ammountTransfer),
      ),
  );
  createBody = Uint8List.fromList(
    createBody.toList()..add(rtgs),
  );
    ...
    createHeader.toList()
      ..addAll(
        createPackageHeader(
          ...
          Constans.PACKAGE_ID_REQUEST_FUND_WITHDRAWAL_ORDER,
        ),
      ),
  );
