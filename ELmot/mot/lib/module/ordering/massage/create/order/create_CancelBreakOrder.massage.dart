...
Uint8List createCancelBreakOrderMassage(
    {required int pin, required String breakID}) {
    ...
    createHeader.toList()
      ..addAll(
        createPackageHeader(
          ...
          Constans.PACKAGE_ID_REQUEST_CANCLE_BREAKE_ORDER,
        ),
      ),
  );
