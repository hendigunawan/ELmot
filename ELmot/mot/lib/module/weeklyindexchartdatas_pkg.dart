...
import 'model/weeklyindexchartdatas_model.dart';

updateWeeklyIndexChartDatas() {
  var getController = Get.find<EncryptControll>();
  getController.readPos.value = Constans.PACKAGE_HEADER_LENGTH;
  WeeklyIndexChartDatasModel listD = WeeklyIndexChartDatasModel();
  List<ArrayWeeklyIndexChartDatasModel> addDataB = [];
  ...
  listD = WeeklyIndexChartDatasModel(
    indexCodeL: idxL,
    indexCode: ic,
    command: command,
    array: Ar,
