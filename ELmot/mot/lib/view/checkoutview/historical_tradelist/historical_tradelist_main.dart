...
import 'package:online_trading/view/checkoutview/historical_tradelist/widget/widget_trade_list.dart';
import 'package:online_trading/view/widget/pin/pin.widget.dart';

class HistoricalTradeListMain extends StatelessWidget {
  const HistoricalTradeListMain({super.key});

  @override
  Widget build(BuildContext context) {
    var dateController = Get.put(DateController());
    dateController.setDefaultTradeListHistori();
          ...
          children: [
            Pin.show(
              onComplete: (a) {
                ...
                OrderMassage.historicaltradeListReq(
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    if (listtradeListHistory.isNotEmpty) {
                      dateController.showFromDate(context, isTradeList: true);
                    }
                  },
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                ...
                GestureDetector(
                  onTap: () async {
                    if (listtradeListHistory.isNotEmpty) {
                      dateController.showtoDate(context, isTradeList: true);
                    }
                  },
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
            ...
            Expanded(
              ...
              child: const WidgetTradeListHistory(),
            ))
          ],
        ),
      ),
