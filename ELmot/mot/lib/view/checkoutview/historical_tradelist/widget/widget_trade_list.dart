...
class WidgetTradeListHistory extends StatelessWidget {
  const WidgetTradeListHistory({super.key});
        ...
        child: Obx(
          () {
            return HorizontalDataTable(
              ...
              itemCount: listtradeListHistory.isEmpty
                  ? 0
                  : listtradeListHistory.first.array!.length,
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: Text(
                              listtradeListHistory
                                  ...
                                  : listtradeListHistory
                                          ...
                                          1
                                      ? 'Sell Order'
                                      : listtradeListHistory.first.array![index]
                                                  .command ==
                                              2
                                          ? 'Margin Buy'
                                          : 'Short Sell',
                          ...
                          Container(
                            ...
                            alignment: Alignment.center,
                            child: Text(
                              listtradeListHistory.first.array![index].orderId!,
                              maxLines: 1,
                              style: TextStyle(
                                color: putihop85,
                                fontSize: 10.sp,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            alignment: Alignment.center,
                            child: Text(
                              listtradeListHistory.first.array![index].board!,
                              maxLines: 1,
                              style: TextStyle(
                                color: putihop85,
                                fontSize: 12.sp,
                          ...
                          Container(
                            ...
                            child: Text(
                              listtradeListHistory
                                      ...
                                      0
                                  ? ''
                                  : dateAjaGarisMiring(listtradeListHistory
                                      .first.array![index].tradeDate),
                              maxLines: 1,
                              style: TextStyle(
                                color: putihop85,
                          ...
                          Container(
                            ...
                            child: Text(
                              listtradeListHistory
                                      ...
                                      0
                                  ? ''
                                  : dateTimeAJa(listtradeListHistory
                                      .first.array![index].tradeTime),
                              maxLines: 1,
                              style: TextStyle(
                                color: putihop85,
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              formattaCurrun(listtradeListHistory
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              listtradeListHistory
                                  .first.array![index].exchangeCode!,
                              maxLines: 1,
                              style: TextStyle(
                                color: putihop85,
                                fontSize: 12.sp,
