...
class CashLedgerMain extends StatelessWidget {
  CashLedgerMain({super.key});
                  ...
                  child: Pin.show(
                    ...
                    onComplete: (text) async {
                      ...
                      sendDatemsg =
                          '$valuesTahun${selectedMonth.toString().length == 1 ? '0$selectedMonth' : selectedMonth}';
                      Get.find<PinSave>().pin.value = text;
                      await OrderMassage.reqCashLedger(
                        text,
                        accountId.value == ""
                            ? Get.find<LoginOrderController>()
                                .order!
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: Obx(() {
                        return Text(
                          "Total : ${listcashLedger.isEmpty ? 0 : listcashLedger.first.array!.length}",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: FontSizes.size13,
                          ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                listcashLedger.isEmpty ? "" : ("${index + 1}"),
                                maxLines: 1,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                listcashLedger.isEmpty
                                    ? ""
                                    : dateAja(listcashLedger
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                formattaCurrun(
                                    listcashLedger.first.array![index].debit!),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                                    color: listcashLedger
                                                .first.array![index].debit ==
                                            0
                                        ? putihop85
                                        : listcashLedger.first.array![index]
                                                    .debit! <
                                                0
                                            ? Colors.red
                                            : Colors.green,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                formattaCurrun(
                                    listcashLedger.first.array![index].credit!),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                                    color: listcashLedger
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Flexible(
                                child: Text(
                                  "  ${listcashLedger.first.array![index].descriptions!}",
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(
                                      color: putihop85,
