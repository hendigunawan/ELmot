...
class BuyBreakOrder extends StatelessWidget {
  final String title;
  final String pin;
  const BuyBreakOrder({super.key, required this.title, required this.pin});
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    onTap: () {
                      controller.priceStap.selection = TextSelection(
                        baseOffset: 0,
                        extentOffset: controller.priceStap.text.length,
                      );
                    },
                    inputFormatters: [
                      FilteringTextInputFormatter.allow(RegExp(r'[0-9]'))
                                ...
                                Text(
                                  formattaCurrun(
                                    controllers.stockEstimasi(
                                      price:
                                          controller.priceContollerBreak.text,
                                      qty: controller.qrtyControllerBreak.text,
                                    ),
                                  ),
                                  style: TextStyle(
